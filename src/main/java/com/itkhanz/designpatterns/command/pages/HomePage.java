package com.itkhanz.designpatterns.command.pages;

import com.itkhanz.designpatterns.command.validator.DismissalAlertValidator;
import com.itkhanz.designpatterns.command.validator.ElementValidator;
import com.itkhanz.designpatterns.command.validator.NotificationValidator;
...
public class HomePage {
  ...
  public List<ElementValidator> getElementValidators(){
    return Arrays.asList(
      //notification
      new NotificationValidator(infoBtn, infoAlert, "info alert"),
      new NotificationValidator(successBtn, successAlert, "success alert"),
      new NotificationValidator(warnBtn, warnAlert, "warn alert"),
      new NotificationValidator(dangerBtn, dangerAlert, "danger alert"),
      //dismiss
